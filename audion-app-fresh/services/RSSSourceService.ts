...
class RSSSourceService {
   ...
   * LEGAL SOURCES ONLY - All sources allow commercial/podcast use
   */
    ...
    return [
      {
        ...
        description: 'NASA公式の最新宇宙開発・科学ニュース（パブリックドメイン）',
      ...
      },
      {
        ...
        description: 'アメリカ国立衛生研究所の医療・健康関連ニュース（パブリックドメイン）',
      ...
      },
      {
        ...
        country: 'US',
        favicon_url: '',
        website_url: 'https://www.usgs.gov',
        popularity_score: 5,
        reliability_score: 5,
        is_active: true,
        is_featured: true,
      ...
      },
      {
        id: 'kantei-jp',
        name: '首相官邸（日本）',
        description: '日本国首相官邸の公式情報・政策ニュース（政府ライセンス）',
        url: 'https://japan.kantei.go.jp/rss.html',
        category: 'general',
        language: 'ja',
        country: 'JP',
        favicon_url: '',
        website_url: 'https://japan.kantei.go.jp',
        popularity_score: 5,
        reliability_score: 5,
        is_active: true,
        is_featured: true,
