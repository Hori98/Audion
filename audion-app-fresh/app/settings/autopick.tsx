            ...
            onPress: async () => {
              try {
                const request = SettingsSyncService.createAutoPickRequest(
                  settings,
                  {
                    max_articles: maxArticles, // Override with UI value
                  },
                  'home' // This is from settings/autopick, treat as 'home' tab
                );
                
                const response = await AudioService.generateAutoPickAudio(request);
