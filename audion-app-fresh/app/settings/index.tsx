...
export default function SettingsScreen() {
  ...
  const handleContentPlaybackPress = () => {
    router.push('/settings/content-playback');
  };

  const handleAutoPickPress = () => {
    router.push('/settings/autopick');
  };

  const handleSchedulePickPress = () => {
        ...
        {selectedTab === 'main' ? (
          ...
          <>
            ...
            <View style={styles.section}>
              ...
              <SettingItem
                title="AutoPick設定"
                description="AI自動記事選択・音声生成"
                icon="magic"
                onPress={handleAutoPickPress}
              />
              <SettingItem
                title="SchedulePick設定"
                description="スケジュール音声生成管理"
                icon="clock-o"
                onPress={handleSchedulePickPress}
              />
              <SettingItem
                title="Manual Pick機能"
              ...
              <SettingItem
                title="🎵 コンテンツ・再生設定"
                description="音声生成モード、品質、再生設定"
                icon="cog"
                onPress={handleContentPlaybackPress}
              />
            </View>
