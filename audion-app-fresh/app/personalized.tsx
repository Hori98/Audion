/**
 * Personalized Articles Page
 * おすすめ記事一覧ページ - Homeセクションの「もっと見る」リンク先
 */
...
import { usePersonalizedFeed, SortOrder } from '../hooks/usePersonalizedFeed';
    ...
    return (
      <>
        ...
        <View style={[styles.header, { paddingTop: insets.top + 12 }]}>
          ...
          <Text style={styles.headerTitle}>おすすめ</Text>
      ...
      {visibleArticles.length === 0 ? (
        <View style={styles.emptyContainer}>
          ...
          <Text style={styles.emptyMessage}>
            選択した条件に合うおすすめ記事がありません。{'\n'}
            フィルターを変更するか、しばらくしてから確認してください。
          </Text>
        </View>
      ) : (
