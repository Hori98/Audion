...
const SkeletonBox: React.FC<SkeletonBoxProps> = ({
  ...
  const animatedStyle = useAnimatedStyle(() => ({
    opacity: interpolate(shimmerTranslateX.value, [-width as number, 0, width as number], [0.3, 0.7, 0.3]),
  }));
      ...
      style={[
        {
          ...
          height,
          borderRadius,
          backgroundColor: '#2a2a2a', // Dark theme skeleton
          overflow: 'hidden',
        },
        animatedStyle,
        style,
